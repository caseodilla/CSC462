...
public class PezCandy implements Serializable, Comparable<PezCandy> {
  ...
  /**
   * Default constuctor sets flavor to value provided in <code>DEFAULT_FLAVOR</code>.
   * 
   */
  public PezCandy() {
    this(DEFAULT_FLAVOR);
  ...
  /**
   * Copy constructor to make a copy of <code>PezCandy</code> passed as an instance.
   * 
   ...
   * @throws CloneNotSupportedException checked exception required to support cloning
  ...
  /**
   * compare passed PezCandy against this to determine if passed PezCandy flavor is less than, equal
   * to or greater than this <code>flavor</code>.
   * 
   * @param aCandy PezCandy instance to compare against current instance
   * 
   * @return int negative if instance flavor is less than instance passed.
  ...
  /**
   * Override toString to provide ease of debugging and printing state of the instance.
   * 
